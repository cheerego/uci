...
--
-- Database: uci
-- Generation Time: 2022-06-23 11:04:01.3740
-- -------------------------------------------------------------
...
INSERT INTO "public"."migrations" ("id", "migration", "batch") VALUES
                                                                   ...
                                                                   ('38', '2022_04_29_075932_create_workflows_table', '2'),
                                                                   ('39', '2022_05_28_020537_create_pipelines_table', '2'),
                                                                   ('40', '2022_06_11_142611_create_runners_table', '2');
...
INSERT INTO "public"."runners" ("id", "code", "salt", "status", "last_status_changed_at", "last_dispatched_at", "created_at", "updated_at", "deleted_at") VALUES
    ('1', '1', '1', 'RUNNING', '2022-06-13 13:32:01', '2022-06-13 13:32:01', '2022-06-13 13:32:01', '2022-06-13 13:32:01', NULL);
...
INSERT INTO "public"."workflows" ("id", "name", "yaml", "creator_id", "envs", "latest_pipeline_id", "latest_success_pipeline_id", "max_concurrent", "build_timeout_second", "created_at", "updated_at", "deleted_at") VALUES
    ('1', 'test-1', 'echo $czj
echo 123123 > 123.txt', '1', '[{"key":"czj","value":"czj6666"}]', '0', '0', '5', '1800', '2022-06-13 15:31:08', '2022-06-15 13:22:37', NULL);
